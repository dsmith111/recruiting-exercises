...
class InventoryAllocation:
    ...
    def filter_warehouse(warehouses, order, inventory_key):
        ...
        return(stocked_warehouses, total_order)
    ...
    def find_shipment(orders, warehouses):
        ...
        for order in orders:
            ...
            if order in product_dist:
                stocked_warehouses, total_order = InventoryAllocation.filter_warehouse(warehouses, order, inventory_key)
